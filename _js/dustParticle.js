...
$(function () {
    ...
    function Particle() {
      ...
      var randomNum = Math.random();
        this.h=parseInt(40 * randomNum + 10);
        this.s=parseInt(40 * randomNum + 10);
        this.l=parseInt(40 * randomNum + 10);
        this.a=0.8*Math.random() ;
      
        this.color = "rgba("+ this.h +","+ this.s +","+ this.l +","+(this.a)+")";
        this.shadowcolor = "rgba("+ this.h +","+ this.s +","+ this.l +","+parseFloat(this.a-0.8)+")";
